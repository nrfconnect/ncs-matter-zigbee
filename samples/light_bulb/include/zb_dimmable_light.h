...
#define ZB_DIMMABLE_LIGHT_CLUSTER_NUM (ZB_DIMMABLE_LIGHT_IN_CLUSTER_NUM + ZB_DIMMABLE_LIGHT_OUT_CLUSTER_NUM)

/** Number of attribute for reporting on Dimmable Light device */
#define ZB_DIMMABLE_LIGHT_REPORT_ATTR_COUNT (ZB_ZCL_ON_OFF_REPORT_ATTR_COUNT + ZB_ZCL_LEVEL_CONTROL_REPORT_ATTR_COUNT)
 ...
 */
#define ZB_DECLARE_DIMMABLE_LIGHT_CLUSTER_LIST(cluster_list_name, basic_attr_list, identify_attr_list,                 \
	...
	zb_zcl_cluster_desc_t cluster_list_name[] = {                                                                  \
		...
		ZB_ZCL_CLUSTER_DESC(ZB_ZCL_CLUSTER_ID_ON_OFF, ZB_ZCL_ARRAY_SIZE(on_off_attr_list, zb_zcl_attr_t),      \
				    (on_off_attr_list), ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_MANUF_CODE_INVALID),        \
		ZB_ZCL_CLUSTER_DESC(ZB_ZCL_CLUSTER_ID_LEVEL_CONTROL,                                                   \
				    ZB_ZCL_ARRAY_SIZE(level_control_attr_list, zb_zcl_attr_t),                         \
				    (level_control_attr_list), ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_MANUF_CODE_INVALID)  \
	}
...
#define ZB_DECLARE_DIMMABLE_LIGHT_EP(ep_name, ep_id, cluster_list)                                                     \
	ZB_ZCL_DECLARE_HA_DIMMABLE_LIGHT_SIMPLE_DESC(ep_name, ep_id, ZB_DIMMABLE_LIGHT_IN_CLUSTER_NUM,                 \
						     ZB_DIMMABLE_LIGHT_OUT_CLUSTER_NUM);                               \
	ZBOSS_DEVICE_DECLARE_REPORTING_CTX(reporting_info##ep_name, ZB_DIMMABLE_LIGHT_REPORT_ATTR_COUNT);              \
	ZBOSS_DEVICE_DECLARE_LEVEL_CONTROL_CTX(cvc_alarm_info##ep_name, ZB_DIMMABLE_LIGHT_CVC_ATTR_COUNT);             \

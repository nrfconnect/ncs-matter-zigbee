...
#ifndef MATTER_ZIGBEE_PROTOCOL_STATE_H_
#define MATTER_ZIGBEE_PROTOCOL_STATE_H_

/** @file
 * @defgroup matter_zigbee_protocol_state Combined Matter + Zigbee protocol state
 * @{
 *
 ...
 * @kconfig{CONFIG_MATTER_ZIGBEE_PROTOCOL_STATE_DEFAULT_PROTOCOL}). Once Matter
 ...
 * value selected by @kconfig{CONFIG_MATTER_ZIGBEE_PROTOCOL_STATE_DEFAULT_PROTOCOL}.
 */
 ...
 * @kconfig{CONFIG_MATTER_ZIGBEE_PROTOCOL_STATE_DEFAULT_PROTOCOL}. Used on
...
#endif /* MATTER_ZIGBEE_PROTOCOL_STATE_H_ */

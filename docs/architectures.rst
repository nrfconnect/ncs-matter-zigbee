...
This page describes the platform designs that are possible to run the combined Matter and Zigbee solution on Nordic Semiconductor devices.
...
This platform design is supported on the following development kits:
